        ...
        <div id="sisianggota">
           <h1 class="h1beranda">Semua Pesan</h1>
            ...
            <div class="kotakadmin">
                <p>
                    <a href="<?php echo site_url('admin_beranda/perbaharui_oleh_admin/' . $row['id_pesan']); ?>">Perbaharui</a>
                    <a href="<?php echo site_url('admin_beranda/hapus_oleh_admin/' . $row['id_pesan']); ?>">Hapus</a>
