    ...
    <body>
        ...
        <div id="sisianggota">
             <?php
                ...
                echo form_open('provinsi/perbaharui/'.$rows->id_provinsi); ?>

                <label for="nama_provinsi">Perbaharui Provinsi</label>
                <input type="text" name="nama_provinsi" value="<?php echo $rows->nama_provinsi?>" />
